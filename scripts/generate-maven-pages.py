    ...
    <section class="dashboard-grid">
      ...
      <div class="card card-metrics">
        ...
        <div style="margin-top: 0.5rem; display: flex; flex-direction: column; align-items: center; gap: 0.5rem;">
          <img src="https://img.shields.io/github/dependents-count/Imajy/eazyCmp?color=06b6d4&amp;style=flat-square&amp;label=Dependent+Projects" alt="Dependent Projects" style="border-radius: 4px; display: inline-block; vertical-align: middle;" />
