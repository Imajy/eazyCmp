...
class OfflineQueueManager internal constructor() : KoinComponent {
    private val database: EazyCmpDatabase by inject()
                    ...
                    try {
                        ...
                        if (payload != null) {
                            val formParts = payload.files.map { part ->
                                ...
                                com.aj.shared.api.FilePart(
                                    name = part.name,
                                    file = com.aj.shared.picker.PickedFile(
                                        bytes = decodedBytes,
                            ...
                            val client: com.aj.shared.api.ApiClient by inject()
